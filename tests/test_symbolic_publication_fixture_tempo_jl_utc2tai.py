...
FIXTURE_PATH = (
    ...
    / "tempo_jl_utc2tai.publication_manifest.json"
)
EXPECTED_NAMES = {
    "cal2jd",
    "calhms2jd",
...
def test_tempo_jl_utc2tai_fixture_surfaces_symbolic_metadata() -> None:
    fixture = _fixture()
    expressions = {
    ...
    assert fixture["modules"] == ["sciona.atoms.physics.tempo_jl.utc2tai.atoms"]
...
def test_tempo_jl_utc2tai_fixture_matches_live_symbolic_manifest() -> None:
    fixture = _fixture()
...
def test_tempo_jl_utc2tai_fixture_loads_without_database_io() -> None:
    fixture = _fixture()
    artifact_ids = {
        row["artifact_key"]: {
