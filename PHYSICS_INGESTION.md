...
So far, 20 remote derivations have been promoted through symbolic expression
rows, PDG relationship rows, and CDG rows across four applied waves.
...
The latest wave, `pdg_remote_wave4_20260505`, promoted:

- `000002`: Euler equation: trig square root
- `000003`: Euler equation: trigonometric relations
- `000007`: electric field wave equation, time-dependent to time-independent
- `000012`: Hermitian operators have real-valued observables
- `000013`: quantum basics orthogonality

The wave 4 dry run and apply both completed with zero graph diagnostics and
zero skipped PDG edges. The apply used authenticated GitHub requests via
`gh-auth-token`; the last observed remaining quota was 4,960 requests.
